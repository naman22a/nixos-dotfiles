...
ShellRoot {
    ...
    stdout: SplitParser {
        onRead: data => {
            ...
            brightnessLevel = parseInt(data.trim()) || 0
        }
    }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Image {
                            anchors.fill: parent
                            source: "file:///home/naman/.config/quickshell/nixos.png"
